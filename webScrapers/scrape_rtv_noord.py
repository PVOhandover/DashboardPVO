...
"""
scrape_rtv_noord.py
Scrapes RTV Noord RSS feed and appends to rtv_noord.json (no duplicates)

Usage:
  python scrape_rtv_noord.py
"""
...
# Configuration
FEED_URL = "https://www.rtvnoord.nl/rss/index.xml"
FEED_NAME = "RTV Noord"
OUTPUT_FILE = "../scrapedArticles/rtv_noord.json"

#!/usr/bin/env python3
"""
scrape_omroep_west.py
Scrapes Omroep West – Economie RSS feed and appends to omroep_west.json (no duplicates)

Usage:
  python scrape_omroep_west.py
"""
...
# Configuration
FEED_URL = "https://www.omroepwest.nl/rss/economie.xml"
FEED_NAME = "Omroep West - Economie"
OUTPUT_FILE = "../scrapedArticles/omroep_west.json"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Omroep West – Economie Scraper")
    print("=" * 60 + "\n")
